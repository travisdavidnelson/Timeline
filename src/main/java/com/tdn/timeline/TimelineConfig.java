...
public class TimelineConfig extends TimelineEvent {
	...
	public int getTickHalfLength() {
		return tickHalfLength;
	}

	public void setTickHalfLength(int tickHalfLength) {
		this.tickHalfLength = tickHalfLength;
	}
